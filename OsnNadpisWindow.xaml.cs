...
namespace DocGOST
{
    ...
    public partial class OsnNadpisWindow : Window
    {
        ...
        {            
            ...
            osnNadpisItem.vedomostValue = gr19PerechenTextBox.Text;
            project.SaveOsnNadpisItem(osnNadpisItem);
            ...
            osnNadpisItem.vedomostValue = gr21PerechenTextBox.Text;
            project.SaveOsnNadpisItem(osnNadpisItem);
            ...
            osnNadpisItem.vedomostValue = gr22PerechenTextBox.Text;
            project.SaveOsnNadpisItem(osnNadpisItem);
